...
/*
Lexical scope - Nested functions have access to the variables and scope of the outer function, including the variables declared inside of the outer scope. 
*/
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const reducedZooArray = array.reduce((accumulator, currentValue) => {
      return accumulator + currentValue.population;
    }, 0);

    return reducedZooArray;
  }
...
console.log('Cb addition:', consume(1,7, add));
...
function multiply(a, b){
  ...
  console.log('Cb multiplication:', consume(1,7, multiply));
